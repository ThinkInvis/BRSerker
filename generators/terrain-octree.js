...
Generators[GenName] = new StagedBrickGenerator(GenName, [
	...
	Controls: {
		...
		NOctaves: $("<input>", {"type":"number", "class":"opt-1-2 opt-input", "min":1, "max":10, "value":6, "step":1}),
		NPersistenceLabel: $("<span>", {"class":"opt-1-2","html":"Persistence:"}),
		NPersistence: $("<input>", {"type":"number", "class":"opt-1-2 opt-input", "min":0, "max":1, "value":0.2, "step":0.001}),
