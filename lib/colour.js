...
// changed HEX2RGBA function to accept a direct numeric hex value instead of a string
...
class Colour {
	 ...
	 */
	static HEX2LAB(hex, opac) {
		const [R, G, b, a] = Colour.HEX2RGBA(hex, opac);
